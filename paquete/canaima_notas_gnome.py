...
specific as possible):"))
        ...
        self.check_lspci = gtk.CheckButton("PCInew")
        self.check_lspci.set_active(True)
        self.check_lsusb = gtk.CheckButton("USBnew")
        self.check_lsusb.set_active(True)
        self.check_ram = gtk.CheckButton("RAM/SWAP/BuffersNew")
        self.check_ram.set_active(True)
        self.check_df = gtk.CheckButton(_("Disk SpaceNew"))
        self.check_df.set_active(True)
        self.check_cpu = gtk.CheckButton("CPUNew")
        self.check_cpu.set_active(True)
        self.check_tm = gtk.CheckButton(_("MotherboardNew"))
